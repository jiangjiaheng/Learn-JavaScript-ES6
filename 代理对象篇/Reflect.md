...
- [Reflect](#reflect)
    - [概述](#概述)
    - [静态方法](#静态方法)
        - [1. Reflect.get(target, name, receiver)](#1-reflectgettarget-name-receiver)
        - [2. Reflect.set(target, name, value, receiver)](#2-reflectsettarget-name-value-receiver)
        - [3. Reflect.has(obj, name)](#3-reflecthasobj-name)
        - [4. Reflect.deleteProperty(obj, name)](#4-reflectdeletepropertyobj-name)
        - [5. Reflect.construct(target, args)](#5-reflectconstructtarget-args)
        - [6. Reflect.getPrototypeOf(obj)](#6-reflectgetprototypeofobj)
        - [7. Reflect.setPrototypeOf(obj, newProto)](#7-reflectsetprototypeofobj-newproto)
        - [8. Reflect.apply(func, thisArg, args)](#8-reflectapplyfunc-thisarg-args)
        - [9. Reflect.defineProperty(target, propertyKey, attributes)](#9-reflectdefinepropertytarget-propertykey-attributes)
        - [10. Reflect.getOwnPropertyDescriptor(target, propertyKey)](#10-reflectgetownpropertydescriptortarget-propertykey)
        - [11. Reflect.isExtensible (target)](#11-reflectisextensible-target)
        - [12. Reflect.preventExtensions(target)](#12-reflectpreventextensionstarget)
        - [13. Reflect.ownKeys (target)](#13-reflectownkeys-target)
    - [实例：使用 Proxy 实现观察者模式](#实例使用-proxy-实现观察者模式)
