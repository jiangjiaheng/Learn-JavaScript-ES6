...
- [Proxy](#proxy)
    ...
    - [实例方法](#实例方法)
        ...
        - [3. apply](#3-apply)
        - [4. has](#4-has)
        - [5. construct](#5-construct)
        - [6. deleteProperty](#6-deleteproperty)
        - [7. defineProperty](#7-defineproperty)
        - [8. getOwnPropertyDescriptor](#8-getownpropertydescriptor)
        - [9. getPrototypeOf](#9-getprototypeof)
        - [10. isExtensible](#10-isextensible)
        - [11. ownKeys](#11-ownkeys)
        - [12. preventExtensions](#12-preventextensions)
        - [13. setPrototypeOf](#13-setprototypeof)
    - [revocable](#revocable)
    - [this问题](#this问题)
