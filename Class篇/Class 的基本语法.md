...
- [Class 的基本语法](#class-的基本语法)
    - [简介](#简介)
        - [1. 类的由来](#1-类的由来)
        - [2. constructor 方法](#2-constructor-方法)
        - [3. 类的实例](#3-类的实例)
        - [4. 取值函数（getter）和存值函数（setter）](#4-取值函数getter和存值函数setter)
        - [5. 属性表达式](#5-属性表达式)
        - [6. Class 表达式](#6-class-表达式)
        - [7. 注意点](#7-注意点)
            - [（1）严格模式](#1严格模式)
            - [（2）不存在提升](#2不存在提升)
            - [（3）name 属性](#3name-属性)
            - [（4）Generator 方法](#4generator-方法)
            - [（5）this 的指向](#5this-的指向)
    - [实例属性的新写法](#实例属性的新写法)
    - [静态属性](#静态属性)
    - [静态方法](#静态方法)
    - [私有方法和私有属性](#私有方法和私有属性)
