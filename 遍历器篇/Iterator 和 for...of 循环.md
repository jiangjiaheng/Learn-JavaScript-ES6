...
- [Iterator 和 for...of 循环](#iterator-和-forof-循环)
    - [Iterator（遍历器）的概念](#iterator遍历器的概念)
    - [默认 Iterator 接口](#默认-iterator-接口)
        - [1. Symbol.iterator属性](#1-symboliterator属性)
        - [2. 原生具备 Iterator 接口](#2-原生具备-iterator-接口)
        - [3. 对象（Object）没有默认部署 Iterator 接口](#3-对象object没有默认部署-iterator-接口)
    ...
    - [for...of 循环](#forof-循环)
        - [1. 数组](#1-数组)
        - [2. Set 和 Map 结构](#2-set-和-map-结构)
        - [3. 计算生成的数据结构](#3-计算生成的数据结构)
        - [4. 类似数组的对象](#4-类似数组的对象)
        - [5. 对象](#5-对象)
        - [6. 与其他遍历语法的比较](#6-与其他遍历语法的比较)
...
### 3. 对象（Object）没有默认部署 Iterator 接口
