...
- [Generator 函数的语法](#generator-函数的语法)
    - [简介](#简介)
        - [1. 基本概念](#1-基本概念)
        - [2. yield 表达式](#2-yield-表达式)
        - [3. 与 Iterator 接口的关系](#3-与-iterator-接口的关系)
    ...
    - [Generator 函数的this](#generator-函数的this)
    - [含义](#含义)
        - [1. Generator 与状态机](#1-generator-与状态机)
        - [2. Generator 与协程](#2-generator-与协程)
            - [（1）协程与子例程的差异](#1协程与子例程的差异)
            - [（2）协程与普通线程的差异](#2协程与普通线程的差异)
        - [3. Generator 与上下文](#3-generator-与上下文)
    - [应用](#应用)
        - [（1）异步操作的同步化表达](#1异步操作的同步化表达)
        - [（2）控制流管理](#2控制流管理)
        - [（3）部署 Iterator 接口](#3部署-iterator-接口)
        - [（4）作为数据结构](#4作为数据结构)
